...
public class EmailUtil {
     ...
     * @param projetoNome
     */
    public synchronized static void mandarEmailRessubmissao(String projetoNome, ArrayList<GerenteRelacionamento> listaDeGerentes) {
                ...
                for (int i = 0; i < listaDeGerentes.size(); i++) {
                    ...
                    try {
                        ...
                        msg.append("<!DOCTYPE html>\n"
                                ...
                                + "			<form>\n"
                                + "				<div style=\"margin-bottom: 15px;\">\n"
                                + "					<a>Olá <strong>" + listaDeGerentes.get(i).getNome() + "</strong>! Notificamos que Plano de Negócio chamado <strong><i>" + projetoNome + "</i></strong> foi renviado.\n"
                                + "							<br/>\n"
