 ...
 */
@WebFilter(filterName = "RecuperarSenhaFilter", urlPatterns = {"/faces/recuperarSenha.xhtml"})
public class RecuperarSenhaFilter implements Filter {
    ...
    public RecuperarSenhaFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RecuperarSenhaFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("RecuperarSenhaFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("RecuperarSenhaFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("RecuperarSenhaFilter()");
        }
        StringBuffer sb = new StringBuffer("RecuperarSenhaFilter(");
