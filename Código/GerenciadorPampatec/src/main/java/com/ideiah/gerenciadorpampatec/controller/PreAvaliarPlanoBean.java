...
//    private String comentObservacoes;
     ...
     */
    public void salvarComentarioTodos(){
    
        ComentarioDao comentDao = new ComentarioDao();
        comentDao.salvarComentarioProjeto(comentarioProjeto);
//        comentDao.salvarComentarioAnalise(comentarioProjeto.getComentarioanaliseemprego());
//        comentDao.salvarComentarioNegocio(comentarioProjeto.getComentarionegocio());
//        comentDao.salvarComentarioPlanoFinanceiro(comentarioProjeto.getComentarioplanofinanceiro());
//        comentDao.salvarComentarioProdutoOuServico(comentarioProjeto.getComentarioprodutoouservico());
