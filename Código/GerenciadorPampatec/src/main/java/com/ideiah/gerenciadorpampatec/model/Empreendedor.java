...
public class Empreendedor implements java.io.Serializable {
     ...
     */
    public static EmpreededorDao getEmpreededorDao() {
        return empreededorDao;
    }

    /**
     * @param aEmpreededorDao the empreededorDao to set
     */
    public static void setEmpreededorDao(EmpreededorDao aEmpreededorDao) {
        empreededorDao = aEmpreededorDao;
    }
    ...
    public static List<Empreendedor> retornarEmpreendedores() {
        setEmpreededorDao(new EmpreededorDao());
    ...
    *
    ...
    public Empreendedor buscarPorCpf(String user) {
        return getEmpreededorDao().buscarPorCpfOUEmail("cpf", user);
    }

    public Empreendedor buscarPorEmail(String user) {
        return getEmpreededorDao().buscarPorCpfOUEmail("email", user);
    }
