...
//        mandarHtml();
        EmailUtil.enviarEmailRecuperarSenha("edisonjhonatan@gmail.com");
//        EmailUtil.mandarEmailConcluirCadastro("Pedro", "Ideiah", "edisonjhonatan@gmail.com");
    ...
    */
    ...
    /*
    Teste do email de recuperacao de senha
    */
    public static void emailRecuperarSenha(String email) {
        ...
        try {
            ...
            msg.append("<html lang=\"pt-br\">\n"
                    ...
                    + "        <form class=\"form-horizontal\">\n"
                    + "            <div class=\"form-group\" style=\"margin-bottom: 15px\">\n"
                    + "                <a>Olá!</a><br/><br/><a>Verificamos que você esqueceu a sua senha. Por favor, <strong>clique na opção a baixo</strong> para redefinir uma nova senha e continuar.</a><br/><br/><a class=\"btn btn-success focus\" href=\"http://localhost:8889/GerenciadorPampatec/faces/terminarCadastroEmpreendedor.xhtml\" style=\"color: #fff;background-color: #3fb618;border-color: #3fb618;display: inline-block;margin-bottom: 0;font-weight: normal;text-align: center;vertical-align: middle;-ms-touch-action: manipulation;touch-action: manipulation;cursor: pointer;background-image: none;border: 1px solid transparent;white-space: nowrap;padding: 10px 18px;font-size: 15px;line-height: 1.428571;border-radius: 0;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none\"><strong>Redefinir minha senha</strong></a>\n"
                    + "            </div>\n"
                    + "\n"
                    + "    </form></div>\n"
                    + "    <div class=\"col-md-4\" style=\"width: 66.333333%\"/>\n"
